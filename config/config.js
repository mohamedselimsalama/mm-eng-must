	...
	modules: [
		{
			module: "MMM-Polly",
			config: {
				voice: "Salli",    // Voice for Polly to use, e.g. "Nicole".
				language: "en-US", // Language for Polly to use, e.g. "en-AU".
				...
				notification: "POLLY_SAID", // notification to send after text has been spoken
			}
		},		
		{
			module: "calendar",
